...
import { stock_purchase, StockPurchaseScheme } from '@/schemas/StockPurchaseSchema'
...
export default function PurchaseStockForm() {

    const form = useForm<StockPurchaseScheme>({
        resolver:zodResolver(stock_purchase),
        defaultValues:{
            branch_id:"",
            item_id:"",
            quantity:0,
...
function handleSubmit(data:StockPurchaseScheme){
    Add({ data }, {
